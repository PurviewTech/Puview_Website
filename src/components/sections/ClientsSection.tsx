...
const clientLogos = [
  ...
  // ✅ NEW LOGO
  { src: "/images/logos/facepro.png", alt: "FacePro" },
];
  ...
  return (
    <section className="py-20 sm:py-32 relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 dark:from-slate-900 dark:via-blue-950/50 dark:to-indigo-950/30">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-gradient-to-r from-purple-400/15 to-pink-400/15 dark:from-purple-300/25 dark:to-pink-300/25 rounded-full blur-3xl animate-pulse"
        ...
        <div
          className="absolute top-1/4 left-1/3 w-2 h-2 bg-blue-400/40 dark:bg-blue-300/60 rounded-full animate-bounce"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute top-3/4 right-1/3 w-1.5 h-1.5 bg-indigo-400/40 dark:bg-indigo-300/60 rounded-full animate-bounce"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute top-1/2 left-1/5 w-1 h-1 bg-purple-400/40 dark:bg-purple-300/60 rounded-full animate-bounce"
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="mb-20 sm:mb-28">
          ...
          >
            ...
            {/* ✅ Added overflow-hidden here too (extra safe) */}
            <div className="rounded-3xl border border-slate-200/50 bg-slate-50/50 backdrop-blur-md px-4 py-6 sm:px-6 overflow-hidden">
